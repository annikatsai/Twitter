...
http://imgur.com/gtpYhc6

GIF created with [LiceCap](http://www.cockos.com/licecap/).

## Notes

One of the bigger challenges of this project was getting used to using fragments, passing data between fragments and activities, and populating fragments with different data in terms of the home timeline, search results, and mentions timeline, for example. Another challenge was getting a newly composed tweet to show up on the timeline once posted. 
